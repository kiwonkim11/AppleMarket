...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(MyItem(R.drawable.sample1, "산진 한달된 선풍기 팝니다", "이사가서 필요가 없어졌어요 급하게 내놓습니다","대현동" , "서울 서대문구 창천동", 1000, 25, 13, false))
        dataList.add(MyItem(R.drawable.sample2, "김치냉장고","이사로인해 내놔요","안마담", "인천 계양구 귤현동", 20000, 28, 8,false))
